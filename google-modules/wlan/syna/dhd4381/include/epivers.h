...
#define EPI_VERSION		101, 10, 591, 45

#define EPI_VERSION_NUM		0x650a24f2

#define EPI_VERSION_DEV		101.10.591

#define EPI_COMMIT_ID		"(ce0be57)"

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"101.10.591.45+ (WLTEST)"
#elif (defined (BCMDBG_ASSERT) && !defined (BCMDBG_ASSERT_DISABLED))
#define EPI_VERSION_STR		"101.10.591.45+ (ASSRT)"
#else
#define EPI_VERSION_STR		"101.10.591.45+"
#endif /* BCMINTERNAL */
